function createUnityInstance(e, r, t) {
    ...
    var h = {
        ...
        SetFullscreen: function () {
            return c.SetFullscreen ? c.SetFullscreen.push(c, arguments) : void c.print("Failed to set Fullscreen mode: Player not loaded yet.");
        },
        SendMessage: function () {
            return c.SendMessage ? c.SendMessage.push(c, arguments) : void c.print("Failed to execute SendMessage: Player not loaded yet.");
        },
        Quit: function () {
            return new Promise(function (r, t) {
                (c.shouldQuit = !0),
        ...
        (c.XMLHttpRequest = (function () {
            ...
            (a.prototype.send = function (r) {
                ...
                return (
                    ...
                    o.enabled
                        ? void l.execute(
                              ...
                              [o.result.url],
                              function (r) {
                                  if (!r || r.version != i.version) return void n.send.push(n, a);
                ...
                (a.prototype.setRequestHeader = function (e, r) {
                    return (this.cache.enabled = !1), this.xhr.setRequestHeader.push(this.xhr, arguments);
                });
        ...
        new Promise(function (e, r) {
            c.SystemInfo.hasWebGL
                ? 1 == c.SystemInfo.hasWebGL
                    ? r('Your browser does not support graphics API "WebGL 2" which is required for this content.')
